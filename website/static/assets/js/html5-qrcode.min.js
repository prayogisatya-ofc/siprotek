function getLazarSoftScanner() {
  ...
  function i(e, t, n, i, r, a) {
    (this.versionNumber = e),
      ...
      (this.ecBlocks = new Array(n, i, r, a));
    for (
      var o = 0, s = n.ECCodewordsPerBlock, h = n.getECBlocks(), c = 0;
      c < h.length;
      c++
    ) {
      var d = h[c];
      o += d.Count * (d.DataCodewords + s);
    }
    (this.totalCodewords = o),
      ...
      (this.buildFunctionPattern = function () {
        ...
        for (var n = this.alignmentPatternCenters.length, i = 0; i < n; i++)
          for (var r = this.alignmentPatternCenters[i] - 2, a = 0; a < n; a++)
            (0 == i && (0 == a || a == n - 1)) ||
              (i == n - 1 && 0 == a) ||
              t.setRegion(this.alignmentPatternCenters[a] - 2, r, 5, 5);
        return (
    ...
    (this.a11 = e),
      ...
      (this.transformPoints2 = function (e, t) {
        for (var n = e.length, i = 0; i < n; i++) {
          var r = e[i],
            a = t[i],
            o = this.a13 * r + this.a23 * a + this.a33;
          (e[i] = (this.a11 * r + this.a21 * a + this.a31) / o),
            (t[i] = (this.a12 * r + this.a22 * a + this.a32) / o);
        }
      }),
    ...
    (this.image = t),
      ...
      (this.sizeOfBlackWhiteBlackRun = function (e, t, n, i) {
        ...
        for (
          ...
          if (
            (1 == l
              ? this.image[w + g * C.width] && l++
              : this.image[w + g * C.width] || l++,
            3 == l)
          ) {
            var m = u - e,
              _ = f - t;
            return Math.sqrt(m * m + _ * _);
          }
          if ((h += s) > 0) {
            if (f == i) break;
            (f += c), (h -= o);
      ...
      (this.sizeOfBlackWhiteBlackRunBothWays = function (e, t, n, i) {
        ...
        o < 0
          ? ((a = e / (e - o)), (o = 0))
          : o >= C.width &&
            ((a = (C.width - 1 - e) / (o - e)), (o = C.width - 1));
        var s = Math.floor(t - (i - t) * a);
        return (
          (a = 1),
          s < 0
            ? ((a = t / (t - s)), (s = 0))
            : s >= C.height &&
              ((a = (C.height - 1 - t) / (s - t)), (s = C.height - 1)),
          (o = Math.floor(e + (o - e) * a)),
          (r += this.sizeOfBlackWhiteBlackRun(e, t, o, s)) - 1
        );
      }),
      ...
      (this.computeDimension = function (e, t, n, i) {
        var r =
          7 +
          ((Math.round(this.distance(e, t) / i) +
            Math.round(this.distance(e, n) / i)) >>
            1);
        switch (3 & r) {
          case 0:
            r++;
      ...
      (this.findAlignmentInRegion = function (e, t, n, i) {
        var r = Math.floor(i * e),
          a = Math.max(0, t - r),
          o = Math.min(C.width - 1, t + r);
        if (o - a < 3 * e) throw "Error";
        var s = Math.max(0, n - r),
          h = Math.min(C.height - 1, n + r);
        return new N(
          this.image,
          a,
          s,
      ...
      (this.createTransform = function (e, t, n, i, a) {
        var o,
          s,
          h,
          c,
        ...
        return (
          null != i
            ? ((o = i.X), (s = i.Y), (h = c = d - 3))
            : ((o = t.X - e.X + n.X), (s = t.Y - e.Y + n.Y), (h = c = d)),
          r.quadrilateralToQuadrilateral(
            3.5,
            3.5,
            d,
            3.5,
      ...
      (this.sampleGrid = function (t, n, i) {
        return e.sampleGrid3(t, i, n);
      }),
      (this.processFinderPatternInfo = function (e) {
        ...
        if (o < 1) throw "Error";
        var s = this.computeDimension(t, n, r, o),
          h = i.getProvisionalVersionForDimension(s),
          c = h.DimensionForVersion - 7,
          d = null;
        if (h.AlignmentPatternCenters.length > 0)
          for (
            var l = n.X - t.X + r.X,
              u = n.Y - t.Y + r.Y,
              f = 1 - 3 / c,
              w = Math.floor(t.X + f * (l - t.X)),
              g = Math.floor(t.Y + f * (u - t.Y)),
              m = 4;
            m <= 16;
            m <<= 1
          ) {
            d = this.findAlignmentInRegion(o, w, g, m);
            break;
          }
        var _ = this.createTransform(t, n, r, d, s);
        return new a(
          this.sampleGrid(this.image, _, s),
          null == d ? new Array(r, t, n) : new Array(r, t, n, d)
        );
      }),
      (this.detect = function () {
        var e = new P().findFinderPattern(this.image);
        return this.processFinderPatternInfo(e);
      });
  }
  (e.checkAndNudgePoints = function (e, t) {
    for (
      var n = C.width, i = C.height, r = !0, a = 0;
      a < t.length && r;
      a += 2
    ) {
      ...
      (r = !1),
        -1 == o ? ((t[a] = 0), (r = !0)) : o == n && ((t[a] = n - 1), (r = !0)),
        -1 == s
          ? ((t[a + 1] = 0), (r = !0))
          : s == i && ((t[a + 1] = i - 1), (r = !0));
    }
    for (r = !0, a = t.length - 2; a >= 0 && r; a -= 2) {
      if (
        ((o = Math.floor(t[a])),
        (s = Math.floor(t[a + 1])),
        o < -1 || o > n || s < -1 || s > i)
    ...
    (e.sampleGrid3 = function (t, n, i) {
      for (var r = new m(n), a = new Array(n << 1), o = 0; o < n; o++) {
        for (var s = a.length, h = o + 0.5, c = 0; c < s; c += 2)
          (a[c] = 0.5 + (c >> 1)), (a[c + 1] = h);
        i.transformPoints1(a), e.checkAndNudgePoints(t, a);
        try {
          for (c = 0; c < s; c += 2)
            t[Math.floor(a[c]) + C.width * Math.floor(a[c + 1])] &&
              r.set_Renamed(c >> 1, o);
        } catch (e) {
          throw "Error.checkAndNudgePoints";
        }
    ...
    (e.sampleGridx = function (
      ...
      var p = r.quadrilateralToQuadrilateral(
        i,
        a,
        o,
        s,
      ...
      return e.sampleGrid3(t, n, p);
    }),
    (i.VERSION_DECODE_INFO = new Array(
      31892,
      34236,
      39577,
      42195,
    ...
    (i.decodeVersionInformation = function (e) {
      for (
        var t = 4294967295, n = 0, r = 0;
        r < i.VERSION_DECODE_INFO.length;
        r++
      ) {
        var a = i.VERSION_DECODE_INFO[r];
        if (a == e) return this.getVersionForNumber(r + 7);
        var o = c.numBitsDiffering(e, a);
        o < t && ((n = r + 7), (t = o));
      }
      return t <= 3 ? this.getVersionForNumber(n) : null;
    }),
    (r.quadrilateralToQuadrilateral = function (
      e,
      t,
      n,
      i,
      ...
      var m = this.quadrilateralToSquare(e, t, n, i, r, a, o, s);
      return this.squareToQuadrilateral(h, c, d, l, u, f, w, g).times(m);
    }),
    (r.squareToQuadrilateral = function (e, t, n, i, a, o, s, h) {
      var c = h - o,
        d = t - i + o - h;
      if (0 == c && 0 == d)
    ...
    (r.quadrilateralToSquare = function (e, t, n, i, r, a, o, s) {
      return this.squareToQuadrilateral(e, t, n, i, r, a, o, s).buildAdjoint();
    });
  var s = new Array(
      new Array(21522, 0),
      new Array(20773, 1),
  ...
  function c(e) {
    (this.errorCorrectionLevel = d.forBits((e >> 3) & 3)),
      (this.dataMask = 7 & e),
  ...
  (c.numBitsDiffering = function (e, t) {
    return (
      h[15 & (e ^= t)] +
      h[15 & A(e, 4)] +
      h[15 & A(e, 8)] +
    ...
    (c.decodeFormatInformation = function (e) {
      var t = c.doDecodeFormatInformation(e);
      return null != t ? t : c.doDecodeFormatInformation(21522 ^ e);
    }),
    (c.doDecodeFormatInformation = function (e) {
      for (var t = 4294967295, n = 0, i = 0; i < s.length; i++) {
        var r = s[i],
          a = r[0];
        if (a == e) return new c(r[1]);
        var o = this.numBitsDiffering(e, a);
        o < t && ((n = r[1]), (t = o));
      }
      return t <= 3 ? new c(n) : null;
    }),
    (d.forBits = function (e) {
  ...
  function m(e, t) {
    ...
    this.__defineGetter__("Width", function () {
      ...
      (this.setRegion = function (e, t, n, i) {
        ...
        if (i < 1 || n < 1) throw "Height and width must be at least 1";
        var r = e + n,
          a = t + i;
        if (a > this.height || r > this.width)
          throw "The region must fit inside the matrix";
        for (var o = t; o < a; o++)
          for (var s = o * this.rowSize, h = e; h < r; h++)
  ...
  function v(e) {
    ...
    (this.bitMatrix = e),
      ...
      (this.readFormatInformation = function () {
        ...
        if (
          ((this.parsedFormatInfo = c.decodeFormatInformation(e)),
        ...
        e = 0;
        var r = i - 8;
        for (t = i - 1; t >= r; t--) e = this.copyBit(t, 8, e);
        for (n = i - 7; n < i; n++) e = this.copyBit(8, n, e);
        if (
          ((this.parsedFormatInfo = c.decodeFormatInformation(e)),
          null != this.parsedFormatInfo)
        )
      ...
      (this.readVersion = function () {
        ...
        var e = this.bitMatrix.Dimension,
          t = (e - 17) >> 2;
        if (t <= 6) return i.getVersionForNumber(t);
        for (var n = 0, r = e - 11, a = 5; a >= 0; a--)
          for (var o = e - 9; o >= r; o--) n = this.copyBit(o, a, n);
        if (
          ((this.parsedVersion = i.decodeVersionInformation(n)),
          null != this.parsedVersion &&
            this.parsedVersion.DimensionForVersion == e)
        )
          return this.parsedVersion;
        for (n = 0, o = 5; o >= 0; o--)
          for (a = e - 9; a >= r; a--) n = this.copyBit(o, a, n);
        if (
          ((this.parsedVersion = i.decodeVersionInformation(n)),
          null != this.parsedVersion &&
            this.parsedVersion.DimensionForVersion == e)
      ...
      (this.readCodewords = function () {
        ...
        for (
          ...
          6 == d && d--;
          for (var l = 0; l < i; l++)
            for (var u = a ? i - 1 - l : l, f = 0; f < 2; f++)
              r.get_Renamed(d - f, u) ||
                (c++,
                (h <<= 1),
                this.bitMatrix.get_Renamed(d - f, u) && (h |= 1),
                8 == c && ((o[s++] = h), (c = 0), (h = 0)));
          a ^= !0;
        }
  ...
  _.getDataBlocks = function (e, t, n) {
    if (e.length != t.TotalCodewords) throw "ArgumentException";
    for (
      var i = t.getECBlocksForLevel(n), r = 0, a = i.getECBlocks(), o = 0;
      o < a.length;
      o++
    )
      r += a[o].Count;
    for (var s = new Array(r), h = 0, c = 0; c < a.length; c++) {
      var d = a[c];
      for (o = 0; o < d.Count; o++) {
        var l = d.DataCodewords,
          u = i.ECCodewordsPerBlock + l;
        s[h++] = new _(l, new Array(u));
      }
    }
    for (
      var f = s[0].codewords.length, w = s.length - 1;
      w >= 0 && s[w].codewords.length != f;

    )
      w--;
    w++;
    var g = f - i.ECCodewordsPerBlock,
      m = 0;
    for (o = 0; o < g; o++) for (c = 0; c < h; c++) s[c].codewords[o] = e[m++];
    for (c = w; c < h; c++) s[c].codewords[g] = e[m++];
    var v = s[0].codewords.length;
    for (o = g; o < v; o++)
      for (c = 0; c < h; c++) {
        var y = c < w ? o : o + 1;
        s[c].codewords[y] = e[m++];
  ...
  function p(e, t) {
    ...
    this.__defineGetter__("Zero", function () {
      ...
      (this.evaluateAt = function (e) {
        ...
        if (1 == e) {
          for (var n = 0, i = 0; i < t; i++)
            n = S.addOrSubtract(n, this.coefficients[i]);
          return n;
        }
        var r = this.coefficients[0];
        for (i = 1; i < t; i++)
          r = S.addOrSubtract(this.field.multiply(e, r), this.coefficients[i]);
        return r;
      }),
      (this.addOrSubtract = function (t) {
        ...
        for (
          var a = new Array(i.length), o = i.length - n.length, s = 0;
          s < o;
          s++
        )
          a[s] = i[s];
        for (var h = o; h < i.length; h++)
          a[h] = S.addOrSubtract(n[h - o], i[h]);
        return new p(e, a);
      }),
      (this.multiply1 = function (e) {
        ...
        for (
          ...
          for (var s = t[o], h = 0; h < r; h++)
            a[o + h] = S.addOrSubtract(a[o + h], this.field.multiply(s, i[h]));
        return new p(this.field, a);
      }),
      (this.multiply2 = function (e) {
        if (0 == e) return this.field.Zero;
        if (1 == e) return this;
        for (
          var t = this.coefficients.length, n = new Array(t), i = 0;
          i < t;
          i++
        )
          n[i] = this.field.multiply(this.coefficients[i], e);
        return new p(this.field, n);
      }),
      (this.multiplyByMonomial = function (e, t) {
        if (e < 0) throw "System.ArgumentException";
        if (0 == t) return this.field.Zero;
        for (
          var n = this.coefficients.length, i = new Array(n + e), r = 0;
          r < i.length;
          r++
        )
          i[r] = 0;
      ...
      (this.divide = function (e) {
        ...
        for (
          var t = this.field.Zero,
            ...
            r = this.field.inverse(i);
          n.Degree >= e.Degree && !n.Zero;

        ) {
          var a = n.Degree - e.Degree,
            o = this.field.multiply(n.getCoefficient(n.Degree), r),
  ...
  function S(e) {
    ...
    var i = new Array(1);
    (i[0] = 0), (this.zero = new p(this, new Array(i)));
    var r = new Array(1);
    (r[0] = 1),
      (this.one = new p(this, new Array(r))),
      this.__defineGetter__("Zero", function () {
        return this.zero;
      }),
    ...
    (y.DATA_MASKS = new Array(
      new (function () {
        (this.unmaskBitMatrix = function (e, t) {
          for (var n = 0; n < t; n++)
            for (var i = 0; i < t; i++) this.isMasked(n, i) && e.flip(i, n);
        }),
  ...
  var b = {};
  (b.rsDecoder = new (function (e) {
    (this.field = e),
      (this.decode = function (e, t) {
        for (
          var n = new p(this.field, e), i = new Array(t), r = 0;
          r < i.length;
          r++
        )
          i[r] = 0;
        var a = !0;
        for (r = 0; r < t; r++) {
          var o = n.evaluateAt(this.field.exp(r));
          (i[i.length - 1 - r] = o), 0 != o && (a = !1);
        }
        if (!a) {
          var s = new p(this.field, i),
            ...
            u = this.findErrorMagnitudes(d, l, !1);
          for (r = 0; r < l.length; r++) {
            var f = e.length - 1 - this.field.log(l[r]);
            if (f < 0) throw "ReedSolomonException Bad error location";
            e[f] = S.addOrSubtract(e[f], u[r]);
          }
        }
      }),
      (this.runEuclideanAlgorithm = function (e, t, n) {
        ...
        for (
          ...
          var d = r,
            l = o,
            u = h;
          if (((o = s), (h = c), (r = a).Zero)) throw "r_{i-1} was zero";
          a = d;
          for (
            var f = this.field.Zero,
              w = r.getCoefficient(r.Degree),
              g = this.field.inverse(w);
            a.Degree >= r.Degree && !a.Zero;

          ) {
            var m = a.Degree - r.Degree,
              _ = this.field.multiply(a.getCoefficient(a.Degree), g);
            (f = f.addOrSubtract(this.field.buildMonomial(m, _))),
              (a = a.addOrSubtract(r.multiplyByMonomial(m, _)));
          }
          (s = f.multiply1(o).addOrSubtract(l)),
            (c = f.multiply1(h).addOrSubtract(u));
        }
        var v = c.getCoefficient(0);
        if (0 == v) throw "ReedSolomonException sigmaTilde(0) was zero";
        var y = this.field.inverse(v),
          p = c.multiply2(y),
          S = a.multiply2(y);
        return new Array(p, S);
      }),
      (this.findErrorLocations = function (e) {
        var t = e.Degree;
        if (1 == t) return new Array(e.getCoefficient(1));
        for (var n = new Array(t), i = 0, r = 1; r < 256 && i < t; r++)
      ...
      (this.findErrorMagnitudes = function (e, t, n) {
        for (var i = t.length, r = new Array(i), a = 0; a < i; a++) {
          for (var o = this.field.inverse(t[a]), s = 1, h = 0; h < i; h++)
            a != h &&
              (s = this.field.multiply(
                s,
                S.addOrSubtract(1, this.field.multiply(t[h], o))
              ));
          (r[a] = this.field.multiply(e.evaluateAt(o), this.field.inverse(s))),
            n && (r[a] = this.field.multiply(r[a], o));
        }
        return r;
      });
  })(S.QR_CODE_FIELD)),
    (b.correctErrors = function (e, t) {
      for (var n = e.length, i = new Array(n), r = 0; r < n; r++)
        i[r] = 255 & e[r];
      var a = e.length - t;
      try {
        b.rsDecoder.decode(i, a);
      } catch (e) {
        throw e;
      }
    ...
    (b.decode = function (e) {
      for (
        var t = new v(e),
          n = t.readVersion(),
          i = t.readFormatInformation().ErrorCorrectionLevel,
          r = t.readCodewords(),
          a = _.getDataBlocks(r, n, i),
          o = 0,
          s = 0;
        s < a.length;
        s++
      ...
      for (var h = new Array(o), c = 0, d = 0; d < a.length; d++) {
        var l = a[d],
          u = l.Codewords,
          f = l.NumDataCodewords;
        for (b.correctErrors(u, f), s = 0; s < f; s++) h[c++] = u[s];
      }
      return new x(h, n.VersionNumber, i.Bits);
    });
  var C = {};
  function A(e, t) {
  ...
  (C.imagedata = null),
    ...
    (C.qrCodeSymbol = null),
    (C.debug = !1),
    (C.maxImgSize = 1048576),
    (C.sizeOfDataLengthInfo = [
      [10, 9, 8, 8],
      [12, 11, 16, 10],
      [14, 13, 16, 12],
    ]),
    (C.callback = null),
    (C.vidSuccess = function (e) {
      (C.localstream = e),
        C.webkit
          ? (C.video.src = window.webkitURL.createObjectURL(e))
          : C.moz
          ? ((C.video.mozSrcObject = e), C.video.play())
          : (C.video.src = e),
        (C.gUM = !0),
        (C.canvas_qr2 = document.createElement("canvas")),
        (C.canvas_qr2.id = "qr-canvas"),
        (C.qrcontext2 = C.canvas_qr2.getContext("2d")),
        (C.canvas_qr2.width = C.video.videoWidth),
        (C.canvas_qr2.height = C.video.videoHeight),
        setTimeout(C.captureToCanvas, 500);
    }),
    (C.vidError = function (e) {
      C.gUM = !1;
    }),
    (C.captureToCanvas = function () {
      if (C.gUM)
        try {
          if (0 == C.video.videoWidth)
            return void setTimeout(C.captureToCanvas, 500);
          (C.canvas_qr2.width = C.video.videoWidth),
            (C.canvas_qr2.height = C.video.videoHeight),
            C.qrcontext2.drawImage(C.video, 0, 0);
          try {
            C.decode();
          } catch (e) {
            console.log(e), setTimeout(C.captureToCanvas, 500);
          }
        } catch (e) {
          console.log(e), setTimeout(C.captureToCanvas, 500);
        }
    }),
    (C.setWebcam = function (e) {
      var t = navigator;
      C.video = document.getElementById(e);
      var n = !0;
      ...
      t.getUserMedia
        ? t.getUserMedia({ video: n, audio: !1 }, C.vidSuccess, C.vidError)
        ...
        : t.mozGetUserMedia &&
          ((C.moz = !0),
          t.mozGetUserMedia({ video: n, audio: !1 }, C.vidSuccess, C.vidError));
    }),
    (C.decode = function (e) {
      if (0 == arguments.length) {
        ...
        return (
          (C.width = t.width),
          (C.height = t.height),
          (C.imagedata = n.getImageData(0, 0, C.width, C.height)),
          (C.result = C.process(n)),
          null != C.callback && C.callback(C.result),
          C.result
        );
      }
      var i = new Image();
      (i.crossOrigin = "Anonymous"),
        (i.onload = function () {
          ...
          if (null != e) {
            ...
            t.clearRect(0, 0, 320, 240), t.drawImage(i, 0, 0, 320, 240);
          }
          var n = document.createElement("canvas"),
            r = n.getContext("2d"),
            a = i.height,
            o = i.width;
          if (i.width * i.height > C.maxImgSize) {
            var s = i.width / i.height;
            o = s * (a = Math.sqrt(C.maxImgSize / s));
          }
          (n.width = o),
            (n.height = a),
            ...
            (C.height = n.height);
          try {
            C.imagedata = r.getImageData(0, 0, n.width, n.height);
          } catch (e) {
            return (
              (C.result =
                "Cross domain image reading not supported in your browser! Save it to your computer then drag and drop the file!"),
              void (null != C.callback && C.callback(C.result))
            );
          }
          try {
            C.result = C.process(r);
          } catch (e) {
            console.log(e), (C.result = "Eror Membaca QR Code");
          }
          null != C.callback && C.callback(C.result);
        }),
        (i.onerror = function () {
          null != C.callback && C.callback("Gagal memuat gambar");
        }),
        (i.src = e);
    }),
    (C.isUrl = function (e) {
    ...
    (C.decode_utf8 = function (e) {
      return C.isUrl(e) ? C.decode_url(e) : e;
    }),
    (C.process = function (e) {
      var t = new Date().getTime(),
        n = C.grayScaleToBitmap(C.grayscale());
      if (C.debug) {
        for (var i = 0; i < C.height; i++)
          for (var r = 0; r < C.width; r++) {
            var a = 4 * r + i * C.width * 4;
            (C.imagedata.data[a] = (n[r + i * C.width], 0)),
              (C.imagedata.data[a + 1] = (n[r + i * C.width], 0)),
              (C.imagedata.data[a + 2] = n[r + i * C.width] ? 255 : 0);
          }
        e.putImageData(C.imagedata, 0, 0);
      }
      var s = new o(n).detect();
      if (C.debug) {
        for (i = 0; i < s.bits.Height; i++)
          for (r = 0; r < s.bits.Width; r++)
            (a = 4 * r * 2 + 2 * i * C.width * 4),
              (C.imagedata.data[a] = (s.bits.get_Renamed(r, i), 0)),
              (C.imagedata.data[a + 1] = (s.bits.get_Renamed(r, i), 0)),
              (C.imagedata.data[a + 2] = s.bits.get_Renamed(r, i) ? 255 : 0);
        e.putImageData(C.imagedata, 0, 0);
      }
      for (var h = b.decode(s.bits).DataByte, c = "", d = 0; d < h.length; d++)
        for (var l = 0; l < h[d].length; l++) c += String.fromCharCode(h[d][l]);
      var u = new Date().getTime() - t;
      return console.log(u), C.decode_utf8(c);
    }),
    (C.getPixel = function (e, t) {
      if (C.width < e) throw "point error";
      if (C.height < t) throw "point error";
      var n = 4 * e + t * C.width * 4;
      return (
        (33 * C.imagedata.data[n] +
          34 * C.imagedata.data[n + 1] +
          33 * C.imagedata.data[n + 2]) /
        100
      );
    }),
    (C.binarize = function (e) {
      for (var t = new Array(C.width * C.height), n = 0; n < C.height; n++)
        for (var i = 0; i < C.width; i++) {
          var r = C.getPixel(i, n);
          t[i + n * C.width] = r <= e;
        }
      return t;
    }),
    (C.getMiddleBrightnessPerArea = function (e) {
      for (
        var t = Math.floor(C.width / 4),
          n = Math.floor(C.height / 4),
          i = new Array(4),
          r = 0;
        r < 4;
        r++
        ...
        i[r] = new Array(4);
        for (var a = 0; a < 4; a++) i[r][a] = new Array(0, 0);
      }
      for (var o = 0; o < 4; o++)
        for (var s = 0; s < 4; s++) {
          i[s][o][0] = 255;
          for (var h = 0; h < n; h++)
            for (var c = 0; c < t; c++) {
              var d = e[t * s + c + (n * o + h) * C.width];
              d < i[s][o][0] && (i[s][o][0] = d),
                d > i[s][o][1] && (i[s][o][1] = d);
            }
        }
      for (var l = new Array(4), u = 0; u < 4; u++) l[u] = new Array(4);
      for (o = 0; o < 4; o++)
        for (s = 0; s < 4; s++)
          l[s][o] = Math.floor((i[s][o][0] + i[s][o][1]) / 2);
      return l;
    }),
    (C.grayScaleToBitmap = function (e) {
      for (
        var t = C.getMiddleBrightnessPerArea(e),
          n = t.length,
          i = Math.floor(C.width / n),
          r = Math.floor(C.height / n),
          a = new ArrayBuffer(C.width * C.height),
          o = new Uint8Array(a),
          s = 0;
        s < n;
        s++
        ...
        for (var h = 0; h < n; h++)
          for (var c = 0; c < r; c++)
            for (var d = 0; d < i; d++)
              o[i * h + d + (r * s + c) * C.width] =
                e[i * h + d + (r * s + c) * C.width] < t[h][s];
      return o;
    }),
    (C.grayscale = function () {
      for (
        var e = new ArrayBuffer(C.width * C.height),
          t = new Uint8Array(e),
          n = 0;
        n < C.height;
        n++
    ...
    (this.x = e),
      ...
      (this.aboutEquals = function (e, t, n) {
        if (Math.abs(t - this.y) <= e && Math.abs(n - this.x) <= e) {
          ...
          return i <= 1 || i / this.estimatedModuleSize <= 1;
        }
        return !1;
      });
  }
  ...
  function P() {
    (this.image = null),
      ...
      (this.foundPatternCross = function (e) {
        ...
        if (t < 7) return !1;
        var r = Math.floor((t << M) / 7),
          a = Math.floor(r / 2);
        return (
          Math.abs(r - (e[0] << M)) < a &&
          Math.abs(r - (e[1] << M)) < a &&
          Math.abs(3 * r - (e[2] << M)) < 3 * a &&
          Math.abs(r - (e[3] << M)) < a &&
          Math.abs(r - (e[4] << M)) < a
        );
      }),
      ...
      (this.crossCheckVertical = function (e, t, n, i) {
        for (
          ...
          o[2]++, s--;
        if (s < 0) return NaN;
        for (; s >= 0 && !r[t + s * C.width] && o[1] <= n; ) o[1]++, s--;
        if (s < 0 || o[1] > n) return NaN;
        for (; s >= 0 && r[t + s * C.width] && o[0] <= n; ) o[0]++, s--;
        if (o[0] > n) return NaN;
        for (s = e + 1; s < a && r[t + s * C.width]; ) o[2]++, s++;
        if (s == a) return NaN;
        for (; s < a && !r[t + s * C.width] && o[3] < n; ) o[3]++, s++;
        if (s == a || o[3] >= n) return NaN;
        for (; s < a && r[t + s * C.width] && o[4] < n; ) o[4]++, s++;
        if (o[4] >= n) return NaN;
        var h = o[0] + o[1] + o[2] + o[3] + o[4];
        return 5 * Math.abs(h - i) >= 2 * i
          ? NaN
      ...
      (this.crossCheckHorizontal = function (e, t, n, i) {
        for (
          var r = this.image, a = C.width, o = this.CrossCheckStateCount, s = e;
          s >= 0 && r[s + t * C.width];

        )
          o[2]++, s--;
        if (s < 0) return NaN;
        for (; s >= 0 && !r[s + t * C.width] && o[1] <= n; ) o[1]++, s--;
        if (s < 0 || o[1] > n) return NaN;
        for (; s >= 0 && r[s + t * C.width] && o[0] <= n; ) o[0]++, s--;
        if (o[0] > n) return NaN;
        for (s = e + 1; s < a && r[s + t * C.width]; ) o[2]++, s++;
        if (s == a) return NaN;
        for (; s < a && !r[s + t * C.width] && o[3] < n; ) o[3]++, s++;
        if (s == a || o[3] >= n) return NaN;
        for (; s < a && r[s + t * C.width] && o[4] < n; ) o[4]++, s++;
        if (o[4] >= n) return NaN;
        var h = o[0] + o[1] + o[2] + o[3] + o[4];
        return 5 * Math.abs(h - i) >= i
          ? NaN
          : this.foundPatternCross(o)
          ? this.centerFromEnd(o, s)
          : NaN;
      ...
      (this.handlePossibleCenter = function (e, t, n) {
        var i = e[0] + e[1] + e[2] + e[3] + e[4],
          ...
          a = this.crossCheckVertical(t, Math.floor(r), e[2], i);
        if (
          !isNaN(a) &&
          ((r = this.crossCheckHorizontal(
            Math.floor(r),
            Math.floor(a),
            e[2],
            i
          ...
          for (
            var o = i / 7, s = !1, h = this.possibleCenters.length, c = 0;
            c < h;
            c++
          ) {
            var d = this.possibleCenters[c];
            if (d.aboutEquals(o, a, r)) {
              d.incrementCount(), (s = !0);
              break;
            }
          }
          if (!s) {
        ...
        if (e > 3) {
          ...
          this.possibleCenters.sort(function (e, t) {
            var n = Math.abs(t.EstimatedModuleSize - a),
              i = Math.abs(e.EstimatedModuleSize - a);
            return n < i ? -1 : n == i ? 0 : 1;
          });
          var o = Math.sqrt(n / e - a * a),
            s = Math.max(0.2 * a, o);
          for (i = this.possibleCenters.length - 1; i >= 0; i--) {
            var h = this.possibleCenters[i];
      ...
      (this.haveMultiplyConfirmedCenters = function () {
        for (
          ...
          r.Count >= I && (e++, (t += r.EstimatedModuleSize));
        }
        if (e < 3) return !1;
        var a = t / n,
          o = 0;
        for (i = 0; i < n; i++)
          (r = this.possibleCenters[i]),
            (o += Math.abs(r.EstimatedModuleSize - a));
        return o <= 0.05 * t;
      }),
      (this.findFinderPattern = function (e) {
        ...
        var t = C.height,
          n = C.width,
          i = Math.floor((3 * t) / (4 * E));
        i < k && (i = k);
        for (var r = !1, a = new Array(5), o = i - 1; o < t && !r; o += i) {
          (a[0] = 0), (a[1] = 0), (a[2] = 0), (a[3] = 0), (a[4] = 0);
          for (var s = 0, h = 0; h < n; h++)
            if (e[h + o * C.width]) 1 == (1 & s) && s++, a[s]++;
            else if (0 == (1 & s))
              if (4 == s)
                if (this.foundPatternCross(a)) {
                  if (this.handlePossibleCenter(a, o, h))
                    if (((i = 2), this.hasSkipped))
                      r = this.haveMultiplyConfirmedCenters();
                    else {
                      var c = this.findRowSkip();
                      c > a[2] && ((o += c - a[2] - i), (h = n - 1));
                    }
                  else {
                    do {
                      h++;
                    } while (h < n && !e[h + o * C.width]);
                    h--;
                  }
                  (s = 0),
                    (a[0] = 0),
          ...
          this.foundPatternCross(a) &&
            ...
            ((i = a[0]),
            this.hasSkipped && (r = this.haveMultiplyConfirmedCenters()));
        }
        var d = this.selectBestPatterns();
        return C.orderBestPatterns(d), new R(d);
      });
  }
  function D(e, t, n) {
    (this.x = e),
    ...
    (this.image = e),
      ...
      (this.crossCheckVertical = function (e, t, n, i) {
        var r = this.image,
          ...
          o = this.crossCheckStateCount;
        (o[0] = 0), (o[1] = 0), (o[2] = 0);
        for (var s = e; s >= 0 && r[t + s * C.width] && o[1] <= n; )
          o[1]++, s--;
        if (s < 0 || o[1] > n) return NaN;
        for (; s >= 0 && !r[t + s * C.width] && o[0] <= n; ) o[0]++, s--;
        if (o[0] > n) return NaN;
        for (s = e + 1; s < a && r[t + s * C.width] && o[1] <= n; ) o[1]++, s++;
        if (s == a || o[1] > n) return NaN;
        for (; s < a && !r[t + s * C.width] && o[2] <= n; ) o[2]++, s++;
        if (o[2] > n) return NaN;
        var h = o[0] + o[1] + o[2];
        return 5 * Math.abs(h - i) >= 2 * i
          ? NaN
      ...
      (this.handlePossibleCenter = function (e, t, n) {
        var i = e[0] + e[1] + e[2],
          r = this.centerFromEnd(e, n),
          a = this.crossCheckVertical(t, Math.floor(r), 2 * e[1], i);
        if (!isNaN(a)) {
          for (
            var o = (e[0] + e[1] + e[2]) / 3,
            ...
            if (this.possibleCenters[h].aboutEquals(o, a, r))
              return new D(r, a, o);
          var c = new D(r, a, o);
      ...
      (this.find = function () {
        for (
          ...
          var c = o + (0 == (1 & h) ? (h + 1) >> 1 : -((h + 1) >> 1));
          (s[0] = 0), (s[1] = 0), (s[2] = 0);
          for (var d = t; d < a && !e[d + C.width * c]; ) d++;
          for (var l = 0; d < a; ) {
            if (e[d + c * C.width])
              if (1 == l) s[l]++;
              else if (2 == l) {
                ...
                if (
                  ...
                  null != (u = this.handlePossibleCenter(s, c, d))
                )
                  return u;
                (s[0] = s[2]), (s[1] = 1), (s[2] = 0), (l = 1);
              } else s[++l]++;
            else 1 == l && l++, s[l]++;
            d++;
          }
          if (
            this.foundPatternCross(s) &&
            null != (u = this.handlePossibleCenter(s, c, a))
          )
            return u;
        }
    ...
    (this.blockPointer = 0),
      ...
      (this.getNextBits = function (e) {
        ...
        if (e < this.bitPointer + 1 + 8) {
          var r = 0;
          for (i = 0; i < this.bitPointer + 1; i++) r += 1 << i;
          return (
            (t =
              (this.blocks[this.blockPointer] & r) <<
              (e - (this.bitPointer + 1))),
            this.blockPointer++,
            (t +=
        ...
        if (e < this.bitPointer + 1 + 16) {
          ...
          for (i = 0; i < this.bitPointer + 1; i++) r += 1 << i;
          var o =
            (this.blocks[this.blockPointer] & r) << (e - (this.bitPointer + 1));
          this.blockPointer++;
          var s =
            this.blocks[this.blockPointer] << (e - (this.bitPointer + 1 + 8));
          for (
            this.blockPointer++, i = 0;
            i < e - (this.bitPointer + 1 + 8);
            i++
          )
            a += 1 << i;
          return (
      ...
      (this.getDataLength = function (e) {
        for (var t = 0; e >> t != 1; ) t++;
        return this.getNextBits(C.sizeOfDataLengthInfo[this.dataLengthMode][t]);
      }),
      (this.getRomanAndFigureString = function (e) {
        ...
        do {
          if (t > 1) {
            ...
            (i += r[Math.floor(n / 45)]), (i += r[a]), (t -= 2);
          } else 1 == t && ((i += r[(n = this.getNextBits(6))]), (t -= 1));
        } while (t > 0);
        return i;
      }),
      (this.getFigureString = function (e) {
        ...
        do {
          t >= 3
            ? ((n = this.getNextBits(10)) < 100 && (i += "0"),
              n < 10 && (i += "0"),
              (t -= 3))
            : 2 == t
            ? ((n = this.getNextBits(7)) < 10 && (i += "0"), (t -= 2))
      ...
      (this.get8bitByteArray = function (e) {
        var t = e,
          ...
          i = new Array();
        do {
          (n = this.getNextBits(8)), i.push(n), t--;
        } while (t > 0);
        return i;
      }),
      (this.getKanjiString = function (e) {
        ...
        do {
          var r,
            a = (((n = this.getNextBits(13)) / 192) << 8) + (n % 192);
          (r = a + 33088 <= 40956 ? a + 33088 : a + 49472),
      ...
      (this.parseECIValue = function () {
        ...
        return (
          0 == (128 & t) && (e = 127 & t),
          128 == (192 & t) && (e = ((63 & t) << 8) | this.getNextBits(8)),
      ...
      this.__defineGetter__("DataByte", function () {
        for (var e = new Array(); ; ) {
          ...
          if (7 == t) var n = this.parseECIValue();
            ...
            var i = this.getDataLength(t);
            if (i < 1) throw "Invalid data length: " + i;
            switch (t) {
              case 1:
                for (
                  var r = this.getFigureString(i),
              ...
              case 2:
                for (
                  r = this.getRomanAndFigureString(i),
                    a = new Array(r.length),
                    o = 0;
                  o < r.length;
                  o++
                ...
                break;
              case 4:
                (n = this.get8bitByteArray(i)), e.push(n);
                break;
              case 8:
                (r = this.getKanjiString(i)), e.push(r);
            }
          }
        }
        return e;
  ...
  return (
    (C.orderBestPatterns = function (e) {
      function t(e, t) {
        var n = e.X - t.X,
          i = e.Y - t.Y;
        return Math.sqrt(n * n + i * i);
...
var Html5Qrcode = (function () {
  function e(t, n) {
    if ((_classCallCheck(this, e), !getLazarSoftScanner))
    ...
    _createClass(
      ...
      [
        {
          ...
          value: function (t, n, i, r) {
            ...
            r || (r = console.log), this._clearElement();
            var o = this,
              s = n || {};
            s.fps = s.fps ? s.fps : e.SCAN_DEFAULT_FPS;
            var h = !1;
            s.videoConstraints &&
              (this._isMediaStreamConstraintsValid(s.videoConstraints)
                ? (h = !0)
                : e._logError(
            ...
            var c = h,
              ...
              u = l.clientWidth ? l.clientWidth : e.DEFAULT_WIDTH;
            if (
              ((l.style.position = "relative"),
              (this._shouldScan = !0),
              (this._element = l),
              (this.qrcode.callback = i),
              d)
            ) {
              var f = s.qrbox;
              if (f < e.MIN_QR_BOX_SIZE)
                throw (
                  "minimum size of 'config.qrbox' is" +
                  " ".concat(e.MIN_QR_BOX_SIZE, "px.")
                );
              if (f > u)
            ...
            var w = function () {
                try {
                  return o.qrcode.decode(), a._possiblyUpdateShaders(!0), !0;
                } catch (e) {
                  return (
                    a._possiblyUpdateShaders(!1),
                    r("QR code parse error, error = ".concat(e)),
                    !1
                  );
                }
              },
              g = function t() {
                if (o._shouldScan) {
                  if (o._localMediaStream) {
                    var n = o._videoElement,
                      i = n.videoWidth / n.clientWidth,
                      r = n.videoHeight / n.clientHeight,
                      h = o._qrRegion.width * i,
                      c = o._qrRegion.height * r,
                      d = o._qrRegion.x * i,
                      l = o._qrRegion.y * r;
                    o._context.drawImage(
                      o._videoElement,
                      d,
                      l,
                      h,
                      ...
                      w() ||
                        !0 === s.disableFlip ||
                        (a._context.translate(a._context.canvas.width, 0),
                        a._context.scale(-1, 1),
                        w());
                  }
                  o._foreverScanTimeout = setTimeout(
                    t,
                    e._getTimeoutFps(s.fps)
                  );
                }
              },
              m = function (e) {
                return new Promise(function (t, n) {
                    ...
                    o._element.append(i),
                      ...
                      (i.onplaying = function () {
                        (function (e, t) {
                          ...
                          var i = d && n <= t,
                            r = i
                              ? a._getShadedRegionBounds(e, t, n)
                              : { x: 0, y: 0, width: e, height: t },
                            h = a._createCanvasElement(r.width, r.height),
                            c = h.getContext("2d");
                          (c.canvas.width = r.width),
                            (c.canvas.height = r.height),
                            l.append(h),
                            i && a._possiblyInsertShadingElement(l, e, t, n),
                            (o._qrRegion = r),
                            (o._context = c),
                            (o._canvasElement = h);
                  ...
                  if (((o._localMediaStream = e), c || !s.aspectRatio)) i();
                  else {
                    var r = { aspectRatio: s.aspectRatio };
                    e.getVideoTracks()[0]
                      .applyConstraints(r)
                      .then(function () {
                        return i();
            ...
            return new Promise(function (e, n) {
              if (
                ...
                var i = c ? s.videoConstraints : o._createVideoConstraints(t);
                navigator.mediaDevices
                  ...
                  .catch(function (e) {
                    n("Error getting userMedia, error = ".concat(e));
                  });
              ...
              } else n("Web camera streaming not supported by the browser.");
            });
          },
        },
        {
          ...
          value: function () {
            ...
            return new Promise(function (n) {
              t.qrcode.callback = null;
              var i = t._localMediaStream.getVideoTracks().length,
                r = 0,
                a = function () {
                  (t._localMediaStream = null),
                    t._element.removeChild(t._videoElement),
                    t._element.removeChild(t._canvasElement),
                    (function () {
                      for (
                        ;
                        ...
                        var n = t._element.getElementsByClassName(
                          e.SHADED_REGION_CLASSNAME
                        )[0];
                        t._element.removeChild(n);
                      }
                    })(),
                    (t._isScanning = !1),
                    t._qrRegion && (t._qrRegion = null),
                    t._context && (t._context = null),
                    n(!0);
                };
              t._localMediaStream.getVideoTracks().forEach(function (e) {
                e.stop(), ++r >= i && a();
              });
            });
          },
        },
        {
          ...
          value: function (t, n) {
            ...
            if (((n = void 0 === n || n), i._isScanning))
              throw "Close ongoing scan before scanning a file.";
            return new Promise(function (r, a) {
              i._possiblyCloseLastScanImageFile(),
                i._clearElement(),
                (i._lastScanImageFile = t);
              var o = new Image();
              (o.onload = function () {
                var t = Math.max,
                  s = o.width,
                  h = o.height,
                  c = document.getElementById(i._elementId),
                  d = c.clientWidth ? c.clientWidth : e.DEFAULT_WIDTH,
                  l = t(
                    c.clientHeight ? c.clientHeight : h,
                    e.FILE_SCAN_MIN_HEIGHT
                  ),
                  u = (function t(n, i, r, a) {
                    if (n <= r && i <= a)
                      return {
                        x: (r - n) / 2,
                        y: (a - i) / 2,
                    ...
                    return (
                      ...
                      e._log(
                        "Image downsampled from " +
                          "".concat(o, "X").concat(s) +
                          " to ".concat(n, "X").concat(i, ".")
                      ),
                      t(n, i, r, a)
                    );
                  })(s, h, d, l);
                if (n) {
                  var f = i._createCanvasElement(d, l, "qr-canvas-visible");
                  (f.style.display = "inline-block"), c.appendChild(f);
                  var w = f.getContext("2d");
                  (w.canvas.width = d),
                    (w.canvas.height = l),
                    w.drawImage(o, 0, 0, s, h, u.x, u.y, u.width, u.height);
                }
                var g = i._createCanvasElement(u.width, u.height);
                c.appendChild(g);
                var m = g.getContext("2d");
                (m.canvas.width = u.width),
                  (m.canvas.height = u.height),
                  m.drawImage(o, 0, 0, s, h, 0, 0, u.width, u.height);
                try {
                  r(i.qrcode.decode());
                } catch (e) {
                  a("QR code parse error, error = ".concat(e));
                }
              }),
                (o.onerror = a),
                (o.onabort = a),
        ...
        },
        {
          ...
          value: function () {
            ...
            return this._localMediaStream.getVideoTracks()[0].getCapabilities();
          },
        },
        {
          ...
          value: function (e) {
            ...
            if (!this._isMediaStreamConstraintsValid(e))
            ...
            return new Promise(function (n, i) {
              "aspectRatio" in e
                ? i("Chaning 'aspectRatio' in run-time is not yet supported.")
                : t._localMediaStream
                    .getVideoTracks()[0]
                    .applyConstraints(e)
                    .then(function (e) {
          ...
          value: function (t, n, i, r) {
            if (!(1 > n - r || 1 > i - r)) {
              ...
              (a.style.position = "absolute"),
                (a.style.borderLeft = "".concat(
                  (n - r) / 2,
                  "px solid #0000007a"
                )),
                (a.style.borderRight = "".concat(
                  (n - r) / 2,
                  "px solid #0000007a"
                )),
                (a.style.borderTop = "".concat(
                  (i - r) / 2,
                  "px solid #0000007a"
                )),
                (a.style.borderBottom = "".concat(
                  (i - r) / 2,
                  "px solid #0000007a"
                )),
                ...
                11 > n - r || 11 > i - r
                  ...
                  : (this._insertShaderBorders(a, 40, 5, -5, 0, !0),
                    this._insertShaderBorders(a, 40, 5, -5, 0, !1),
                    this._insertShaderBorders(a, 40, 5, r + 5, 0, !0),
                    this._insertShaderBorders(a, 40, 5, r + 5, 0, !1),
                    this._insertShaderBorders(a, 5, 45, -5, -5, !0),
                    this._insertShaderBorders(a, 5, 45, r + 5 - 40, -5, !0),
                    this._insertShaderBorders(a, 5, 45, -5, -5, !1),
                    this._insertShaderBorders(a, 5, 45, r + 5 - 40, -5, !1),
        ...
        },
        {
          ...
          value: function (t, n, i, r, a, o) {
            ...
            (s.style.position = "absolute"),
              (s.style.backgroundColor = e.BORDER_SHADER_DEFAULT_COLOR),
              (s.style.width = "".concat(n, "px")),
              (s.style.height = "".concat(i, "px")),
              (s.style.top = "".concat(r, "px")),
              o
                ? (s.style.left = "".concat(a, "px"))
                : (s.style.right = "".concat(a, "px")),
              ...
              (this.hasBorderShaders &&
                ...
                this.borderShaders.forEach(function (n) {
                  n.style.backgroundColor = t
                    ? e.BORDER_SHADER_MATCH_COLOR
                    : e.BORDER_SHADER_DEFAULT_COLOR;
                }),
              (this.qrMatch = t));
          },
        },
        ...
        },
        {
          ...
          value: function (e) {
            ...
            if ("object" != _typeof(e)) {
              var t = _typeof(e);
              throw "Invalid type of 'cameraIdOrConfig' = ".concat(t);
            }
            var n = { user: !0, environment: !0 },
              i = function (e) {
                if (e in n) return !0;
                throw (
            ...
            if (1 != r.length)
              throw (
                ...
                " if passed as an object, found ".concat(r.length, " keys")
              );
            var a = Object.keys(e)[0];
            if ("facingMode" != a && "deviceId" != a)
              throw (
                "Only '"
            ...
            if ("facingMode" != a) {
              var o = e[a];
              if ("string" == typeof o) return { deviceId: o };
              if ("object" == _typeof(o)) {
                if ("exact" in o) return { deviceId: { exact: o.exact } };
                throw (
              ...
              var s = _typeof(o);
              throw "Invalid type of 'deviceId' = ".concat(s);
            }
            var h = e[a];
            if ("string" == typeof h) {
              if (i(h)) return { facingMode: h };
            } else {
              if ("object" != _typeof(h)) {
                var c = _typeof(h);
                throw "Invalid type of 'facingMode' = ".concat(c);
              }
              if (!("exact" in h))
                throw (
              ...
              if (i(h.exact)) return { facingMode: { exact: h.exact } };
            }
          },
        },
        {
          ...
          value: function (t) {
            if (!t) return e._logError("Empty videoConstraints", !0), !1;
            if ("object" !== _typeof(t)) {
              var n = _typeof(t);
              return (
                e._logError(
                  "videoConstraints should be of type object, the " +
                    "object passed is of type ".concat(n, "."),
                  !0
                ),
                !1
              );
            ...
            for (
              ...
              if (((i = a[o]), r.has(i)))
                return (
                  e._logError(
                    "".concat(i, " is not supported videoConstaints."),
                    !0
                  ),
                  !1
                );
      ...
      [
          ...
          value: function () {
            ...
            return new Promise(function (t, n) {
              if (
                ...
                e._log("navigator.mediaDevices used"),
                  navigator.mediaDevices
                    .getUserMedia({ audio: !1, video: !0 })
                    .then(function (i) {
                      i.oninactive = function () {
                        return e._log("All streams closed");
                      };
                      navigator.mediaDevices
                        .enumerateDevices()
                        .then(function (n) {
                          for (var r, a = [], o = 0; o < n.length; o++)
                            "videoinput" == (r = n[o]).kind &&
                              a.push({ id: r.deviceId, label: r.label });
                          e._log("".concat(a.length, " results found")),
                            (function (e) {
                              for (
                                var t, n = e.getVideoTracks(), i = 0;
                                i < n.length;
                                i++
                              )
                                ((t = n[i]).enabled = !1),
                        ...
                        .catch(function (e) {
                          n("".concat(e.name, " : ").concat(e.message));
                        });
                    })
                    .catch(function (e) {
                      n("".concat(e.name, " : ").concat(e.message));
                ...
                e._log("MediaStreamTrack.getSources used");
                MediaStreamTrack.getSources(function (n) {
                  for (var i, r = [], a = 0; a !== n.length; ++a)
                    "video" === (i = n[a]).kind &&
                      r.push({ id: i.id, label: i.label });
                  e._log("".concat(r.length, " results found")), t(r);
                });
              } else
                e._log("unable to query supported devices."),
                  n("unable to query supported devices.");
            });
          },
        },
        {
        ...
        },
        {
          key: "_log",
          value: function (t) {
            e.VERBOSE && console.log(t);
          },
        },
        {
          key: "_logError",
          value: function (t, n) {
            (e.VERBOSE || !0 === n) && console.error(t);
          },
        },
      ]
    ),
...
var Html5QrcodeScanner = (function () {
  function e(t, n, i) {
    ...
    (this.currentScanType = e.SCAN_TYPE_CAMERA),
    ...
    _createClass(e, [
      {
        ...
        value: function (t, n) {
          ...
          (this.lastMatchFound = void 0),
            (this.qrCodeSuccessCallback = function (n) {
              if ((i.__setStatus("MATCH", e.STATUS_SUCCESS), t)) t(n);
              else {
                if (i.lastMatchFound == n) return;
                (i.lastMatchFound = n),
                  i.__setHeaderMessage(
                    "Last Match: ".concat(n),
                    e.STATUS_SUCCESS
                  );
              }
            }),
            (this.qrCodeErrorCallback = function (e) {
              i.__setStatus("Scanning"), n && n(e);
            });
          var r = document.getElementById(this.elementId);
          (r.innerHTML = ""),
            this.__createBasicLayout(r),
        ...
        value: function () {
          var e = this,
            ...
            n = function () {
              ...
              t && ((t.innerHTML = ""), e.__resetBasicLayout(t));
            };
          if (this.html5Qrcode)
            return new Promise(function (e, i) {
              t.html5Qrcode._isScanning &&
                t.html5Qrcode
                  .stop()
                  .then(function () {
                    t.html5Qrcode.clear(), n(), e();
                  })
                  .catch(function (e) {
                    t.verbose &&
                      console.error("Unable to stop qrcode scanner", e),
                      i(e);
                  });
            });
        },
      },
      {
        ...
        value: function (e) {
          (e.style.position = "relative"),
            (e.style.padding = "0px"),
            this.__createHeader(e);
          var t = document.createElement("div"),
            n = this.__getScanRegionId();
          (t.id = n),
            (t.style.width = "100%"),
          ...
          var i = document.createElement("div"),
            r = this.__getDashboardId();
          (i.id = r),
            (i.style.width = "100%"),
            e.appendChild(i),
            this.__setupInitialDashboard(i);
        },
      },
      {
      ...
      },
      {
        ...
        value: function (e) {
          ...
          (n.innerHTML = "Scanner"),
            (n.style.color = "#5369f8"),
            (n.style.fontSize = ".875rem"),
            t.appendChild(n);
          var i = document.createElement("span");
          (i.id = this.__getStatusSpanId()),
            (i.style.float = "right"),
            (i.style.padding = "5px 7px"),
            (i.style.fontSize = "14px"),
            (i.style.background = "#dedede6b"),
            (i.style.border = "1px solid #00000000"),
            (i.style.color = "#5369f8"),
            t.appendChild(i),
            this.__setStatus("IDLE");
          var r = document.createElement("div");
          (r.id = this.__getHeaderMessageContainerId()),
      ...
      },
      {
        ...
        value: function (e) {
          var t = document.createElement("div");
          (t.id = this.__getDashboardSectionId()),
            (t.style.width = "100%"),
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            n = document.getElementById(this.__getDashboardSectionId()),
            i = document.createElement("div");
          n.appendChild(i);
          var r = document.createElement("div");
          (r.id = this.__getDashboardSectionCameraScanRegionId()),
            (r.style.display =
              this.currentScanType == e.SCAN_TYPE_CAMERA ? "block" : "none"),
            i.appendChild(r);
          var a = document.createElement("div");
          a.style.textAlign = "center";
          var o = document.createElement("button");
          (o.className = "btn btn-primary mb-2"),
            (o.innerHTML = "Minta Persetujuan Akses Kamera"),
            o.addEventListener("click", function () {
              (o.disabled = !0),
                t.__setStatus("PERMISSION"),
                t.__setHeaderMessage("Meminta persetujuan kamera..."),
                Html5Qrcode.getCameras()
                  .then(function (n) {
                    t.__setStatus("IDLE"),
                      t.__resetHeaderMessage(),
                      n && 0 != n.length
                        ? (r.removeChild(a), t.__renderCameraSelection(n))
                        : t.__setStatus("Tidak ada kamera", e.STATUS_WARNING);
                  })
                  .catch(function (n) {
                    (o.disabled = !1),
                      t.__setStatus("IDLE"),
                      t.__setHeaderMessage(n, e.STATUS_WARNING);
                  });
            }),
            a.appendChild(o),
            r.appendChild(a);
          var s = document.createElement("div");
          (s.id = this.__getDashboardSectionFileScanRegionId()),
            (s.style.textAlign = "center"),
            (s.style.display =
              this.currentScanType == e.SCAN_TYPE_CAMERA ? "none" : "block"),
            i.appendChild(s);
          var h = document.createElement("input");
          (h.id = this.__getFileScanInputId()),
            (h.accept = "image/*"),
            (h.type = "file"),
            (h.style.width = "200px"),
            (h.disabled = this.currentScanType == e.SCAN_TYPE_CAMERA);
          var c = document.createElement("span");
          (c.innerHTML = "&nbsp; Pilih Gambar"),
            s.appendChild(h),
            s.appendChild(c),
            h.addEventListener("change", function (n) {
              if (
                t.currentScanType === e.SCAN_TYPE_FILE &&
                ...
                t.html5Qrcode
                  .scanFile(i, !0)
                  .then(function (e) {
                    t.__resetHeaderMessage(), t.qrCodeSuccessCallback(e);
                  })
                  .catch(function (n) {
                    t.__setStatus("ERROR", e.STATUS_WARNING),
                      t.__setHeaderMessage(n, e.STATUS_WARNING),
                      t.qrCodeErrorCallback(n);
                  });
              }
            });
        },
      },
      {
        ...
        value: function (t) {
          ...
          (r.innerHTML = "<span class='mb-2'>Pilih kamera (".concat(t.length, ")</span>")),
            (r.style.display = "flex");
            (r.style.flexDirection = "column");
          var a = document.createElement("select");
          a.classList.add('form-control');
          a.classList.add('form-control-sm');
          a.classList.add('form-select');
          a.classList.add('w-auto');
          a.classList.add('mb-2');
          a.id = this.__getCameraSelectionId();
          for (var o = 0; o < t.length; o++) {
            var s = t[o],
              h = s.id,
              c = null == s.label ? h : s.label,
              d = document.createElement("option");
            (d.value = h), (d.innerHTML = c), a.appendChild(d);
          }
          r.appendChild(a), i.appendChild(r);
          var l = document.createElement("span"),
            u = document.createElement("button");
          (u.innerHTML = "Mulai Scanning"),
            l.appendChild(u),
            (u.className = "btn btn-primary mb-2 me-2");
          var f = document.createElement("button");
          (f.className = "btn btn-primary mb-2"),
            (f.innerHTML = "Berhenti Scanning"),
            ...
            u.addEventListener("click", function () {
              (a.disabled = !0),
                (u.disabled = !0),
                n._showHideScanTypeSwapLink(!1);
              var t = n.config ? n.config : { fps: 10, qrbox: 250 },
                i = a.value;
              n.html5Qrcode
                .start(i, t, n.qrCodeSuccessCallback, n.qrCodeErrorCallback)
                .then(function () {
                  (f.disabled = !1),
                    (f.style.display = "inline-block"),
                    (u.style.display = "none"),
                    n.__setStatus("Scanning");
                })
                .catch(function (t) {
                  n._showHideScanTypeSwapLink(!0),
                    (a.disabled = !1),
                    (u.disabled = !1),
                    n.__setStatus("IDLE"),
                    n.__setHeaderMessage(t, e.STATUS_WARNING);
                });
            }),
                ...
                n.html5Qrcode
                  ...
                  .then(function () {
                    n._showHideScanTypeSwapLink(!0),
                      ...
                      n.__setStatus("IDLE"),
                      n.__insertCameraScanImageToScanRegion();
                  })
                  .catch(function (t) {
                    (f.disabled = !1),
                      n.__setStatus("ERROR", e.STATUS_WARNING),
                      n.__setHeaderMessage(t, e.STATUS_WARNING);
                  });
            });
        },
      },
      {
        ...
        value: function () {
          var t = this,
            n = "Scan File Gambar",
            i = "Scan menggunakan kamera",
            r = document.getElementById(this.__getDashboardSectionId()),
            a = document.createElement("div");
          a.style.textAlign = "center";
          var o = document.createElement("a");
          (o.style.textDecoration = "underline"),
            (o.id = this.__getDashboardSectionSwapLinkId()),
            (o.innerHTML = this.currentScanType == e.SCAN_TYPE_CAMERA ? n : i),
            (o.href = "#scan-using-file"),
            o.addEventListener("click", function () {
              return t.sectionSwapAllowed
                ? (t.__setStatus("IDLE"),
                  t.__resetHeaderMessage(),
                  (t.__getFileScanInput().value = ""),
                  (t.sectionSwapAllowed = !1),
                  t.currentScanType == e.SCAN_TYPE_CAMERA
                    ? (t.__clearScanRegion(),
                      (t.__getFileScanInput().disabled = !1),
                      (t.__getCameraScanRegion().style.display = "none"),
                      (t.__getFileScanRegion().style.display = "block"),
                      (o.innerHTML = i),
                      (t.currentScanType = e.SCAN_TYPE_FILE),
                      t.__insertFileScanImageToScanRegion())
                    : (t.__clearScanRegion(),
                      (t.__getFileScanInput().disabled = !0),
                      (t.__getCameraScanRegion().style.display = "block"),
                      (t.__getFileScanRegion().style.display = "none"),
                      (o.innerHTML = n),
                      (t.currentScanType = e.SCAN_TYPE_CAMERA),
                      t.__insertCameraScanImageToScanRegion()),
                  void (t.sectionSwapAllowed = !0))
                : void (
                    t.verbose &&
      ...
      },
      {
        key: "__setStatus",
        value: function (t, n) {
          n || (n = e.STATUS_DEFAULT);
          var i = document.getElementById(this.__getStatusSpanId());
          switch (((i.innerHTML = t), n)) {
            case e.STATUS_SUCCESS:
              (i.style.background = "#6aaf5042"), (i.style.color = "#477735");
              break;
            case e.STATUS_WARNING:
              (i.style.background = "#cb243124"), (i.style.color = "#cb2431");
              break;
            case e.STATUS_DEFAULT:
            default:
              (i.style.background = "#eef"),
      ...
      },
      {
        ...
        value: function (t, n) {
          n || (n = e.STATUS_DEFAULT);
          var i = document.getElementById(this.__getHeaderMessageContainerId());
          switch (((i.innerHTML = t), (i.style.display = "block"), n)) {
            case e.STATUS_SUCCESS:
              (i.style.background = "#6aaf5042"), (i.style.color = "#477735");
              break;
            case e.STATUS_WARNING:
      ...
      },
      {
        ...
        value: function (e) {
          !0 !== e && (e = !1),
            ...
            (this.__getDashboardSectionSwapLink().style.display = e
              ? "inline-block"
              : "none");
        },
      },
      {
        ...
        value: function () {
          var t = this,
            n = document.getElementById(this.__getScanRegionId());
          return this.cameraScanImage
            ? ((n.innerHTML = "<br>"), void n.appendChild(this.cameraScanImage))
            : ((this.cameraScanImage = new Image()),
              (this.cameraScanImage.onload = function () {
                (n.innerHTML = "<br>"), n.appendChild(t.cameraScanImage);
              }),
              (this.cameraScanImage.width = 64),
              (this.cameraScanImage.style.opacity = 0.3),
              void (this.cameraScanImage.src = e.ASSET_CAMERA_SCAN));
        },
      },
      {
        ...
        value: function () {
          ...
          return this.fileScanImage
            ? ((n.innerHTML = "<br>"), void n.appendChild(this.fileScanImage))
            : ((this.fileScanImage = new Image()),
              (this.fileScanImage.onload = function () {
                (n.innerHTML = "<br>"), n.appendChild(t.fileScanImage);
              }),
              (this.fileScanImage.width = 64),
              (this.fileScanImage.style.opacity = 0.3),
              void (this.fileScanImage.src = e.ASSET_FILE_SCAN));
        },
      },
      {
        key: "__clearScanRegion",
        value: function () {
          document.getElementById(this.__getScanRegionId()).innerHTML = "";
        },
      },
      {
...
_defineProperty(Html5QrcodeScanner, "SCAN_TYPE_CAMERA", "SCAN_TYPE_CAMERA"),
  ...
  _defineProperty(
    Html5QrcodeScanner,
    "ASSET_FILE_SCAN",
    "/static/assets/img/scanqr/scan.png"
  ),
  _defineProperty(
    Html5QrcodeScanner,
    "ASSET_CAMERA_SCAN",
    "/static/assets/img/scanqr/qr-code-scan.png"
  );
